...
def get_daily_papers(topic,query="Try-on", max_results=2):
    """
    @param topic: str
    @param query: str
    ...
    for result in search_engine.results():
        if result.summary and "try-on" or "Try-on" or "try on" in result.summary:
...
if __name__ == "__main__":
    ...
    json_file = "Try-on-arxiv-daily.json"
